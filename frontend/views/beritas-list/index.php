...
<?php foreach ($databerita as $dataBeritas) { 

	//echo "____________________".$dataBeritas->berita_id."<br>";
}
			...
			<div class="banner-form banner-form-full job-list-form">
				<form action="#">
					...
					<div class="dropdown category-dropdown">						
						<a data-toggle="dropdown" href="#"><span class="change-text">Berita Kategori</span> <i class="fa fa-angle-down"></i></a>
						<ul class="dropdown-menu category-change">


						<?php foreach ($datacategory as $dataCategories) { ?>
							<li><a href="#"><?php echo Html::encode($dataCategories->category_name); ?></a></li>
						<?php } ?>
						</ul>								
					</div><!-- category-change -->
				...
				<div class="row">
								...
								<div class="panel panel-default panel-faq">
									...
									<div id="accordion-one" class="panel-collapse collapse in">
										...
										<div class="panel-body">
											...
											<?php foreach ($datacategory as $dataCategories) { ?>
												<li><a href="<?php echo Html::encode($dataCategories->category_id); ?>"><?php echo Html::encode($dataCategories->category_name); ?></a></span> <span>(<?php echo Html::encode($dataCategories->jumlah); ?>)</span></a></li>
					...
					<div class="col-sm-8 col-md-7">				
								...
								<div class="item-info">
									<div class="item-image-box">
										<div class="item-image">
											<a href="job-details.html"><img src="<?php Yii::$app->request->baseUrl; ?>/images/job/1.png" alt="Image" class="img-responsive"></a>
										</div><!-- item-image -->
									</div>

									<div class="ad-info">
										<span><a href="job-details.html" class="title"><?php echo Html::encode($dataBeritas->judul_berita); ?></a> @ <a href="#"><?php echo Html::encode($dataBeritas->jenis_berita); ?></a></span>
										<div class="ad-meta">
											<ul>
												<li><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i><?php echo Html::encode($dataBeritas->alamat); ?></a></li>
												<li><a href="#"><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo Html::encode($dataBeritas->updated_at); ?></a></li>
												<li><a href="#"><i class="fa fa-money" aria-hidden="true"></i><?php echo Html::encode($dataBeritas->user_id); ?></a></li>
												<li><a href="#"><i class="fa fa-tags" aria-hidden="true"></i>
												<?php 
												    if ($dataBeritas->status_ditemukan=='1'){ echo Html::encode('Belum Ditemukan'); } 
												elseif ($dataBeritas->status_ditemukan=='2'){ echo Html::encode('Sudah Ditemukan'); } 
												elseif ($dataBeritas->status_ditemukan=='3'){ echo Html::encode('Belum diambil oleh pemiliknya'); } 
												else { echo Html::encode('Sudah diambil oleh pemiliknya'); } 
						...
						<?php } ?>
							...
							<div class="ad-section text-center">
								<a href="#"><img src="<?php Yii::$app->request->baseUrl; ?>/images/ads/3.jpg" alt="Image" class="img-responsive"></a>
							</div><!-- ad-section -->							
							...
							<div class="job-ad-item">
								<div class="item-info">
									<div class="item-image-box">
										<div class="item-image">
											<a href="job-details.html"><img src="<?php Yii::$app->request->baseUrl; ?>/images/job/11.png" alt="Image" class="img-responsive"></a>
										</div><!-- item-image -->
									</div>
							...
							<div class="job-ad-item">
								<div class="item-info">
									<div class="item-image-box">
										<div class="item-image">
											<a href="job-details.html"><img src="<?php Yii::$app->request->baseUrl; ?>/images/job/12.png" alt="Image" class="img-responsive"></a>
										</div><!-- item-image -->
									</div>
							...
							<div class="job-ad-item">
								<div class="item-info">
									<div class="item-image-box">
										<div class="item-image">
											<a href="job-details.html"><img src="<?php Yii::$app->request->baseUrl; ?>/images/job/17.png" alt="Image" class="img-responsive"></a>
										</div><!-- item-image -->
									</div>
							...
							<div class="job-ad-item">
								<div class="item-info">
									<div class="item-image-box">
										<div class="item-image">
											<a href="job-details.html"><img src="<?php Yii::$app->request->baseUrl; ?>/images/job/18.png" alt="Image" class="img-responsive"></a>
										</div><!-- item-image -->
									</div>
					...
					<div class="col-md-2 hidden-xs hidden-sm">
						<div class="advertisement text-center">
							<a href="#"><img src="<?php Yii::$app->request->baseUrl; ?>/images/ads/1.jpg" alt="" class="img-responsive"></a>
						</div>
					</div>
				</div>	
			</div>
