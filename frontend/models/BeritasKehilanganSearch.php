...
/**
 * BeritasKehilanganSearch represents the model behind the search form about `frontend\models\Beritas`.
 */
class BeritasKehilanganSearch extends Beritas
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['jenis_berita', 'judul_berita', 'deskripsi_berita', 'tanggal_kejadian', 'email', 'no_telp1', 'no_telp2', 'pin_bb', 'status', 'created_at', 'updated_at'], 'safe'],
        ];
    }
