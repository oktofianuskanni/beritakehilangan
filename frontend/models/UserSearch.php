...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'status', 'created_at', 'updated_at', 'province_id', 'regency_id', 'district_id', 'village_id', 'status_account'], 'integer'],
            [['nama_lengkap', 'username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'alamat', 'telephone', 'mobile_handphone', 'pin_bb'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'nama_lengkap', $this->nama_lengkap])
            ...
            ->andFilterWhere(['like', 'mobile_handphone', $this->mobile_handphone])
