...
class UserController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            //$get_user_id = User::find()->where(['username' => Yii::$app->user->identity->username,'id'=>$_GET['id']])->one();
            $get_user_id = User::find()->where(['username' => Yii::$app->user->identity->username])->one();
            //echo 'get_user_id : '.$get_user_id->id.'<br>';
            //exit();

            if ($get_user_id->id==$_GET['id']){
