...
use frontend\models\BeritasKehilanganSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * BeritasKehilanganController implements the CRUD actions for Beritas model.
 */
class BeritasKehilanganController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new BeritasKehilanganSearch();
