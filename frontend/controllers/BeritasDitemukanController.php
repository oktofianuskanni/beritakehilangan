...
use frontend\models\BeritasDitemukanSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * BeritasDitemukanController implements the CRUD actions for Beritas model.
 */
class BeritasDitemukanController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new BeritasDitemukanSearch();
